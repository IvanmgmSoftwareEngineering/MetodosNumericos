                ...
                %los siguientes puntos:
                    ...
                    %    (En caso de existir alguno)
                        ...
                        % Buscamos puntos Estacionarios
                            ...
                            % polinomio. Entonces tenemos dos opciones para
                            % encontrar donde dh(x) se anula en el caso de 
                            % no ser dh(x) un polinomio:
                                %  Opcion 1: Utilizar la funcion 'fzeros' ya
                                ...
                                % Opcion 2: Desarrolar un algortimo que
                    ...
                    %    existir alguno)
                           ...
                           %dividiremos el Intervalo Cerrado [0,pi/2] 
                           %en m puntos equiespaciados una distancia de 0.0001
                           %pnh = puntos donde h(x) No es Diferenciable
                           %gnh = Evaluacion de h(x) en los puntos donde h(x) No 
                           %      es Diferenciable
...
%                                 end
                ...
                %particularizada en el Exgtremo inferior del intervalo
                %[a,b], h(x) particularizada en el Extremo Sperior del
